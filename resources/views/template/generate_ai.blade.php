...
<div class="response" >
    ...
    <div class="form-group mt-3" >
        {{ Form::textarea('description', null, ['class' => 'form-control richText-editor','rows' => 1,'placeholder' => __('Description'),'id'=>'ai-richtext-editor']) }}
...
<script>
    ...
    function copySelectedText() {
        ...
        var id2 = document.querySelector('.richText-editor').id;
        $('#ai-richtext-editor').focus();
        $('#ai-richtext-editor').select();
        document.execCommand('copy');
        var copied = $("#"+id2+"").text();
        var selected = $('input[name="template_name"]:checked').attr('data-name');
        var selectedText = window.getSelection().toString();
        var input= $('input[name='+selected+']').length;
        $('#ai-richtext-editor').after("Copied to clipboard");
        if(input>0){
